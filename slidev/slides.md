...
<!--
重要な点として共有したいのが現在のJIS規格は改正作業が進んでおり、WCAG 2.2をベースにしたものに更新される予定があるということです。

今年9月に国際規格であるISOが改訂され、新しいJISは2026年夏ごろに公示される見込みです。
...
- 独自で検証したものもありケースによってはうまく適応しない可能性もあります
...
<!--
生成AIでアクセシビリティ改善を楽にすることは、あくまで「手段」です。
